...
## Les 13 métiers de la donnée

Nous avons défini une liste de 13 "métiers de la donnée” où le terme apparaît le plus (≥ 17 fois), sinon dans l’intitulé.
...
.footnote[Labelle S., Gilliard A., Haÿ L. (2017). « [Datactive : Cultivez vos capacités à jouer avec des données](https://frama.link/datactive) »
Tessier, L. et Tremion, V. (2019). « La certification des compétences numériques dans les universités françaises : du C2i à Pix », Revista Universitara de Sociologie, XV, n° Hors-Série 2, p. 13‑23
<br />]
