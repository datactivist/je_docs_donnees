...
## La donnée, une compétence opérationnelle et une activité principale
...
## La donnée, facteur majeur d'évolution à moyen terme des emplois-types

```{r referens_facteurs_d_evolution_moyen_terme}
data_filtered %>%
